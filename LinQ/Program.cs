...
namespace LinQ
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var beersNameReal = from b in beersName select new
            {
                Name = b.Name
            };
            ...
            var beersMéxico = from b in beers where b.Country == "México" || b.Country == "Alemania" select b;
            ...
            var orderedBeersDesc = from b in beers orderby b.Country descending select b;
            foreach (var beer in orderedBeersDesc) Console.WriteLine(beer);
        }
    }
